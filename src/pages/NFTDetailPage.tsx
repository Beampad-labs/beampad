            ...
            <motion.div variants={itemVariants} className="glass-card rounded-3xl p-6 space-y-4">
              ...
              <div className="rounded-2xl border border-border bg-canvas-alt p-4 space-y-1">
                ...
                <p className="text-body-sm text-ink-muted">
                  Current price: <span className="font-medium text-ink">{formatEther(unitPrice)} {nativeToken}</span>
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="text-body-sm text-ink-muted space-y-1">
                  <p>Price per NFT: {formatEther(unitPrice)} {nativeToken}</p>
                  <p className="font-medium text-ink">Total: {formatEther(totalCost)} {nativeToken}</p>
                ...
                {!userCanMintCurrentPhase ? (
                  ...
                  >
                    {isBusy ? (
                      ...
                      `Mint ${mintQty} NFT${mintQty > 1 ? 's' : ''} · ${formatEther(totalCost)} ${nativeToken}`
                    )}
                  </button>
                )}
              </div>
