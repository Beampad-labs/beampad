...
import { NFTFactory, getContractAddresses, getExplorerUrl, getNativeTokenLabel } from '@/config';
import {
  AlertTriangle,
  CheckCircle2,
  ExternalLink,
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1.7fr)_minmax(320px,0.95fr)] gap-8 items-start">
        <div className="space-y-6">
          ...
          <motion.section variants={itemVariants} className="glass-card rounded-3xl p-6 space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-1.5">
                <label className="text-body-sm text-ink-muted font-medium">Public Price ({nativeToken})</label>
                <input
                  type="text"
                  value={mintPrice}
          ...
          <motion.section variants={itemVariants} className="glass-card rounded-3xl p-6 space-y-5">
            ...
            <div className={`grid grid-cols-1 md:grid-cols-2 gap-4 ${whitelistEnabled ? '' : 'opacity-60'}`}>
              ...
              <div className="space-y-1.5">
                <label className="text-body-sm text-ink-muted font-medium">Whitelist Price ({nativeToken})</label>
                <input
                  type="text"
